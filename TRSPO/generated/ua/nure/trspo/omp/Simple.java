...
public class Simple {
	public static void main(String[] args) {
		...
		/* === OMP CONTEXT === */
class OMPContext_iwQ {
	public int local_foo;
}
final OMPContext_iwQ ompContext_669 = new OMPContext_iwQ();
ompContext_669.local_foo = foo;
final org.omp4j.runtime.IOMPExecutor ompExecutor_nbC = new org.omp4j.runtime.DynamicExecutor(Runtime.getRuntime().availableProcessors());
/* === /OMP CONTEXT === */
for (int ompI = 0; ompI < Runtime.getRuntime().availableProcessors(); ompI++) {
	ompExecutor_nbC.execute(new Runnable(){
		@Override
		public void run() {
{
			System.out.println("hello");
			System.out.println("world");
			System.out.println(ompContext_669.local_foo);
		}		}
	});
}
ompExecutor_nbC.waitForExecution();
	foo = ompContext_669.local_foo;
